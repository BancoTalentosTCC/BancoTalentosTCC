if (Meteor.isClient) {
  ...
  FlowRouter.route('/recuperar-senha', {
    ...
    title: "Banco de Talentos - Recuperar senha",
    action: function(params) {
      BlazeLayout.render('HomeLayout', {main: "recover" });
    },
    triggersEnter: [
      function() {
        Session.set("isRecoveryScreen", true);
      }
    ],
    triggersExit: [
      function() {
        Session.set("isRecoveryScreen", false);
      }
    ]
  });
  ...
  FlowRouter.route( '/reset-password/:token', {
    name: 'resetPassword',
    title: "Banco de Talentos - Nova senha",
    action: function(params) {
      BlazeLayout.render('HomeLayout', {main: "reset" });
    },
    triggersEnter: [
      function() {
        Session.set("isRecoveryScreen", true);
